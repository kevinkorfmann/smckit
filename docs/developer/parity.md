...
**Remaining tasks:** Add accession-recorded human and nonhuman empirical cases, test the pinned OCI/Apptainer runtime, broaden optimizer families, and run the paired frozen performance benchmark on macOS ARM64 before changing the `auto` default.
