...
**Remaining tasks:** Add structured PAC and trunk-style simulations, establish a repaired-source marginal-KL oracle, complete the original-compatible artifact catalogue, and gather Linux plus broader-workflow performance evidence before reconsidering the native trust warning.
