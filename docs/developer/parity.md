...
**Remaining tasks:** Add accession-recorded human and nonhuman empirical cases, test the pinned OCI/Apptainer runtime, broaden optimizer families, and rerun correctness plus the frozen benchmark on macOS ARM64 before changing the `auto` default.
