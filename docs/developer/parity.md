...
**Remaining tasks:** Add accession-recorded human and nonhuman empirical cases, test the pinned OCI/Apptainer runtime, and broaden optimizer families before changing the `auto` default.
**References:** :doc:`methods/psmcplus`, ``tests/unit/test_psmcplus_native_preprocessing.py``, ``tests/unit/test_psmcplus_native_kernels.py``, ``tests/unit/test_psmcplus_native_fit.py``, ``tests/integration/test_psmcplus_upstream_validation.py``, ``benchmarks/psmcplus/``, ``workflow/publication/evidence/psmcplus-promotion/sha256-5aa89ae3/``
...
**Remaining tasks:** Add empirical PAC analyses and gather Linux plus broader-workflow performance evidence before reconsidering the native trust warning.
